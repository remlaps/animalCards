...
2. **Picks a rarity from a fixed slot pool** shared by every class. The slot counts
...
`card_id: 12`. It takes Common slot 3 (previously generic). Slots 0–2 are untouched.
